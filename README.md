...
##### Question 1. ___Have total emissions from PM2.5 decreased in the United States from 1999 to 2008? Using the base plotting system, make a plot showing the total PM2.5 emission from all sources for each of the years 1999, 2002, 2005, and 2008.___
...
####A.: The Emissions from coal combustion related sources have decreased from 1999-2008 on 1/3 of its values.
...
####A.: The Emissions from motor vehicle sources have large decreased from 1999-2008 in Baltimore City.
...
####A.: We can see a huge difference between Baltimore City and Los Angeles County: in Baltimore tendency to decrease the emissions from motor vehicle sources, but in LA first seeing an increase value of the emissions from motor vehicle sources and after changed to decrease by 2008.
